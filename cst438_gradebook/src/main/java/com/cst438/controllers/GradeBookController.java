...
public class GradeBookController {
	...
	@Transactional
	public void addAssignment(@PathVariable int course_id, @RequestParam String assignment_name, @RequestParam String due_date, @AuthenticationPrincipal OAuth2User principal) {
	...
	@Transactional
	public void updateAssignmentName(@PathVariable int assignment_id, @RequestParam String assignment_name, @AuthenticationPrincipal OAuth2User principal) {
		String email = principal.getAttribute("email");   // user name (should be instructor's email) 
